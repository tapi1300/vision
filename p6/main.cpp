...
void add_cloud(pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud, bool is_plane)
{
	...
	if(is_plane)
	{
		...
		viewer->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_COLOR, r,g,b, string);
	}
	pc_adddeds++;
}
...
int main(int argc, char** argv)
{
	...
	// // Con esta linea se puede añadir o quitar que se muestre la 
	// //	pointcloud original (en blanco)
	add_cloud(cloud_filtered, false);
